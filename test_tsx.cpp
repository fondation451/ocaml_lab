...
#define __force_inline __attribute__((__gnu_inline__)) inline

static __force_inline int _xbeginb(void)
{
...
static __force_inline void _xendb(void)
{
	asm volatile (".byte 0x0f,0x01,0xd5"
			::: "memory");
}

static __force_inline void _xabortb(const unsigned int status)
{
